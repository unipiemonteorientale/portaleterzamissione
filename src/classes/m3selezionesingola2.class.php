 ...
 */
class M3SelezioneSingola2 extends M3Risposta {
    ...
    public function display($options=array()) {
        ...
        $rs = $db->Execute($sql, array($options["codice_domanda"]));
        $list = $rs->GetArray();
...
EOT;
        ...
        $smarty->display("ui-selezionesingola2.tpl");
        echo "</div>";
    }
    ...
    public function input($options=array()) {
        $session = getSession();
        error_log("M3SelezioneSingola2::input ({$this->_object_name})");
